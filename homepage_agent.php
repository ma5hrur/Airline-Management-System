...
<html>
    <head>
       ...
       <link rel="stylesheet" href="homepage_agent.css">
    </head>
    <body>
        ...
        <div id="container">
            ...
            <div id="rightsidebar">
                <div class = embassy_box>
                    <p><a href="embassy_page.php">Embassy</a></p>
                    <a href="embassy_page.php"><img src="images/building_icon_transparent.png"></a>
                </div>
            </div>
        </div>
